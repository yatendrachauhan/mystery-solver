function loadDeathCalculator() {
    ...
    !function (e, r) {
      ...
      if (!e.OmniC) {
        ...
        n = function () {
          e.addEventListener("message", y, !1),
            p()
        }
          ,
            ...
            switch (p.type) {
              ...
              case "LOADED":
                return void function (e) {
                  ...
                  if (!n)
                    return;
                  var o, a = n.getAttribute("data-currency"), i = n.getAttribute("data-config");
                  if (i)
                    try {
                      o = JSON.parse(i)
                    } catch (t) { }
              ...
              case "READY":
                return void function (t) {
                  ...
                  a.call(m, function (t) {
                    ...
                    e.classList && (e.classList.remove(l),
                      e.classList.add(s))
                }(h(p.calculatorId))
            }
        }
